...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (['PUT', 'PATCH'].includes(req.method || '')) return updateStatus(req, res, orderId(req));
