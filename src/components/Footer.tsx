  ...
  return (
    <footer id="main-footer" className="bg-[#211C18] text-[#D8CEC3] pt-16 pb-12 border-t border-[#3D332C]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-8 border-b border-[#382F28] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <a href="https://www.trustpilot.com/evaluate/luvia-decor.cz" target="_blank" rel="noopener noreferrer" aria-label="Ohodnotit Luvia Decor na Trustpilot" className="flex items-center gap-3 p-3 rounded-xl bg-[#28211C] hover:bg-[#322923] border border-[#3E332A] hover:border-[#00B67A] transition group text-xs"><div className="w-9 h-9 rounded-lg bg-[#00B67A]/20 text-[#00B67A] flex items-center justify-center shrink-0 font-black text-lg">★</div><div className="overflow-hidden flex-1"><span className="block text-[10px] uppercase text-[#8F8174] font-semibold">Hodnocení zákazníků</span><span className="text-[#FAF6F0] font-bold truncate block group-hover:text-[#00B67A] transition">Ohodnotit nás na Trustpilot</span></div><ExternalLink className="w-4 h-4 text-[#00B67A] shrink-0" /></a>
