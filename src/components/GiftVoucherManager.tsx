...
export const GiftVoucherManager: React.FC = () => {
  ...
  const create = async () => {
    ...
    try {
      const r = await fetch('/api/coupons', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ code: clean, type: 'fixed', value: amount, active: true, note: 'gift-voucher', adminUser }) });
