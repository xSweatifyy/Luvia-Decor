...
import { AlertTriangle, Ban, Scale, ShieldAlert, Clock3 } from 'lucide-react';
  ...
  <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
    <div className="bg-white rounded-3xl border border-[#E8DFC8] shadow-sm overflow-hidden">
      ...
      <div className="p-6 sm:p-8 space-y-6 text-sm leading-7 text-[#5C5046]">
        ...
        <div className="rounded-2xl border border-[#E3DACF] bg-[#F7F3EE] p-5"><div className="flex items-center gap-2"><Clock3 className="w-5 h-5 text-[#8C7355]" /><h3 className="font-editorial text-xl font-bold text-[#2D2723]">Ukončení konzultace a opuštění prostor</h3></div><p className="mt-2">Po ukončení konzultace je zákazník povinen bez zbytečného odkladu opustit prostory určené pro konzultace a další obchodní prostory Luvia Decor, pokud nebyl předem dohodnut jiný důvod nebo termín návštěvy. Po skončení konzultace není zákazník oprávněn bez souhlasu provozovatele setrvávat v budově ani vstupovat do neveřejných prostor.</p><p className="mt-3">Pokud zákazník přes výzvu personálu prostory neopustí nebo se v nich neoprávněně zdržuje, může být vyzván k okamžitému odchodu. Pokud výzvu opakovaně nerespektuje, může provozovatel k řešení situace přivolat Policii ČR. V případě problémového, agresivního nebo jinak závažně nevhodného jednání může být zákazník z obchodních prostor okamžitě vyveden v rozsahu dovoleném právními předpisy.</p></div>
